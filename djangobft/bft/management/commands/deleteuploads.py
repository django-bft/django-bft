from bft.app_settings import FILE_UPLOAD_DIR, APP_NAME, UPLOAD_EXPIRATION_DAYS
...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		files_dir = os.listdir(settings.MEDIA_ROOT + FILE_UPLOAD_DIR)
		date_dir = (datetime.today() - timedelta(days=UPLOAD_EXPIRATION_DAYS)).strftime('%d-%m-%Y')

		for dir in files_dir:
			if dir != date_dir:
				dir_temp = settings.MEDIA_ROOT + FILE_UPLOAD_DIR + '/' + dir
