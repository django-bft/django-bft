            ...
            if user_subnet not in CAPTCHA_SUBNET_EXCLUDE:
                ...
                try:
                    ...
                    if not response['success']:
                        Exception('Verifyme Error: The URLs for Verifyme is invalid.  '
                            'Please check your app_settings.py')
                    
                except IOError:
                    raise Exception('Verifyme Error:  There is an error communicating '
